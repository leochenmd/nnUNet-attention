...
class ResidualClassifyinnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
        ...
        ################################
        self.segmentation_model_path = os.path.join(r'C:\Users\Leo\Documents\UHN-MedImg3D-ML-quiz\nnUNet_results\Dataset002_PancreasLesion\nnUNetTrainer__nnUNetResEncUNetMPlans__3d_fullres\fold_' + str(fold), 'checkpoint_best.pth')
        ################################
