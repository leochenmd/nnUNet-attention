...
class nnUNetDataLoaderBaseClassify(DataLoader):
    def __init__(self,
                 data: nnUNetDatasetClassify,
                 batch_size: int,
    ...
    def determine_shapes(self):
        # load one case
        data, seg, properties, lesion = self._data.load_case(self.indices[0])
    ...
    def get_bbox(self, data_shape: np.ndarray, force_fg: bool, class_locations: Union[dict, None],
        ...
        if not force_fg and not self.has_ignore:
            ...
            if not force_fg and self.has_ignore:
                ...
                eligible_classes_or_regions = [2]  ## only gets patches with lesions
